    ...
    def post(self, request):
        try:
            ...
            for product in products:
                ...
                if (bundle_id and
                    not product.bundleoption_set.filter(id=bundle_id).exists()) or \
                    (color_size_id and
                    not product.colorsizeoption_set.filter(id=color_size_id).exists()):
                ...
                existing_product = cart.orderproduct_set.filter(
                    ...
                    (Q(color_size_id=color_size_id) | Q(bundle_id=bundle_id))
                ).first()
                ...
                if existing_product:
                    ...
                    newly_added_products.append(order_product)
